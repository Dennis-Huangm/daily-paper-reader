...
tldr: 该研究针对双队列系统中的多智能体决策问题，提出了一种结合非线性观点动力学的新框架。不同于传统的纯理性优化模型，该框架引入了受社交互动影响的内部观点状态，用以模拟智能体在队列选择时的偏好演化。研究证明了系统在特定条件下能达到拥塞博弈的纳什均衡，并通过仿真揭示了社交互动和信息获取对集体行为的影响，为理解服务系统中的复杂群体行为提供了新视角。
selection_source: fresh_fetch
motivation: 传统队列模型多假设智能体完全理性，难以捕捉社交互动对决策的影响及排队选择时的犹豫不决。
method: 引入非线性观点动力学来模拟智能体的内部偏好状态，并将其作为决定加入或切换队列的核心驱动力。
result: 证明了在满足特定参数条件下，描述系统演化的马尔可夫链能在有限期望时间内达到底层拥塞博弈的纳什均衡。
conclusion: 该框架有效整合了社交影响与理性决策，揭示了信息透明度和群体互动在塑造集体排队行为中的关键作用。
---

## 摘要
我们引入了一种排队系统中多智能体决策的新框架，该框架利用非线性观点动力学的敏捷性和鲁棒性，来打破排队选择过程中的犹豫不决，并捕捉社交互动对集体行为的影响。排队模型是理解服务场景中多智能体行为的核心。许多先前的模型假设每个智能体的决策过程是基于优化的，并受对排队系统变化的理性反应所支配。与此不同，我们引入了一个由非线性观点动力学驱动的内部观点状态，用于表示智能体在两个可用队列之间偏好强度的演变。该观点状态受到社交互动的影响，而社交互动可以修正纯粹的理性反应。我们提出了一类新的排队模型子类，其中每个智能体的行为决策（例如加入或切换队列）由这种演变的观点状态决定。我们证明了一个充分参数条件，该条件保证了描述演变观点和排队系统状态的马尔可夫链能在有限期望时间内达到潜在拥塞博弈的纳什均衡。随后，我们通过数值模拟探索了该新框架的丰富性，阐明了社交互动以及个体获取系统信息的能力在塑造集体行为中的作用。
