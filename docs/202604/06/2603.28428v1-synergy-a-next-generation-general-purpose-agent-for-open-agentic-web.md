...
tldr: 随着AI智能体普及，互联网正向去中心化的“开放智能体网络”演进。针对现有智能体孤立且缺乏社交属性的问题，本文提出“智能体公民”概念并设计了Synergy架构。该架构通过会话原生编排、持久化身份标识和经验中心化学习，实现了智能体间的开放协作、身份延续与持续进化，为构建大规模协作的智能体生态提供了通用框架。
selection_source: fresh_fetch
motivation: 现有AI智能体多为孤立工具或封闭系统，缺乏在开放、去中心化网络中进行跨组织协作、身份识别和持续进化的能力。
method: 提出Synergy架构，通过存储库支持的工作空间实现协作，利用类型化记忆构建身份，并采用经验中心化学习机制实现进化。
result: Synergy成功实现了具备协作原生性、身份持久性和终身进化能力的“智能体公民”原型。
conclusion: Synergy为开放智能体网络提供了关键的基础设施，推动了智能体从单一工具向社会化参与者的转变。
---
