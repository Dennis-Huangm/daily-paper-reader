...
tldr: 针对动态环境下存在通信延迟的多智能体次模最大化问题，本文提出分布式在线贪婪（DOG）算法。该算法结合对抗性老虎机学习与延迟反馈机制，实现了任意网络拓扑下的同步决策。研究量化了去中心化带来的次优性成本，并揭示了协调性能与收敛时间随通信延迟变化的权衡关系，在全中心化与局部协调方法之间取得了平衡。
selection_source: fresh_fetch
motivation: 现有分布式次模最大化方法在处理通信延迟时，要么因串行通信导致高延迟，要么因仅限局部协调而限制了性能。
method: 提出DOG算法，利用带延迟反馈的对抗性老虎机学习工具，使多智能体能够在任意网络拓扑下进行同步决策。
result: 给出了算法相对于最优解的近似性能界限，并明确了网络结构与通信延迟对协调性能和收敛速度的影响。
conclusion: DOG算法成功填补了全中心化与全去中心化协调方案之间的空白，为延迟环境下的分布式信息采集任务提供了有效方案。
---
