...
tldr: 针对多智能体强化学习中因策略并发更新导致的非平稳性问题，本文提出了GRASP框架。该框架通过“主动共享感知”机制，利用各智能体的独立梯度推导出共识梯度，将广义贝尔曼均衡定义为稳定的策略演化目标。通过理论证明与实验验证，该方法有效缓解了环境波动引起的均衡振荡，显著提升了系统在复杂协作任务中的收敛速度和性能。
selection_source: fresh_fetch
motivation: 现有多智能体算法在感知他方策略更新时处于被动状态，导致环境持续波动、均衡振荡及收敛缓慢。
method: 提出GRASP框架，利用智能体的独立梯度推导共识梯度，实现对策略更新的主动感知与梯度重对齐。
result: 在SMAC和GRF等复杂多智能体基准测试中，该框架展现了卓越的可扩展性和优于现有方法的性能。
conclusion: GRASP通过梯度重对齐机制有效解决了非平稳性问题，为多智能体协作优化提供了具备理论保证的稳定均衡解。
---
