...
motivation: 现有的强化学习探索方法往往只关注状态新颖性或策略熵，而忽略了状态的潜在价值和物理规律的引导。
method: 提出一种利用可微动力学模型产生的解析策略梯度来引导探索的方法，将任务感知和物理信息注入探索过程。
result: 该方法成功引导智能体转向高奖励区域，实现了更快速且更有效的策略学习。
conclusion: 通过结合解析梯度与有向探索，本研究显著提升了在线策略强化学习在机器人控制任务中的学习效率。
---
