...
tags: ["query:ag-rl"]
score: 10.0
evidence: 在在线框架中通过强化学习训练的LLM智能体
tldr: RetroAgent是一个在线强化学习框架，旨在解决LLM智能体在复杂交互任务中容易陷入局部最优且缺乏显式经验学习的问题。该框架通过事后自我反思产生双重内在反馈：数值反馈追踪子任务进度以奖励探索，语言反馈将经验提炼至记忆库。结合SimUtil-UCB检索策略，RetroAgent在多个挑战性任务上显著超越了GRPO等基准方法，展现出卓越的进化能力和泛化性能。
selection_source: fresh_fetch
motivation: 传统的强化学习范式使智能体倾向于静态解决问题而非持续进化，导致探索不足且难以显式利用过往经验。
method: 提出双重内在反馈机制，结合数值化的子任务进度奖励与基于SimUtil-UCB策略检索的语言经验记忆库。
result: "在ALFWorld、WebShop等四个任务上显著优于GRPO，最高提升达27.1%，并表现出极强的分布外泛化能力。"
conclusion: RetroAgent通过将“解决问题”转变为“自我进化”，为构建具备持续学习和自适应能力的自主智能体提供了有效路径。
---
