...
tldr: "针对多智能体强化学习在边缘设备上因高频推理导致的高能耗问题，本文提出ETD-MAPPO算法。该方法引入双门控认知触发器，让智能体根据策略熵和价值分歧自主调节执行频率。通过SMDP建模和异步梯度掩码评论家，在保持任务性能的同时，将计算开销降低了73.6%，并实现了涌现的时间角色分工。"
...
result: "在多个复杂任务中，该方法在减少73.6%计算量的同时，性能较基准模型提升了60%以上，并有效防止了策略崩溃。"
